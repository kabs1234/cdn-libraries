...
export default function Filter(): ReactElement {
  ...
  const onShowFilterButtonClick = (): void => {
    if (isFilterActive) {
  ...
  return (
    <>
      <button
        className="flex ml-auto mr-auto mt-5 items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none"
